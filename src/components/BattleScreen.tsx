...
export const BattleScreen: React.FC<BattleScreenProps> = ({
  ...
  return (
    <div className={`w-full min-h-[calc(100vh-80px)] ${isFinal ? 'bg-[#1A1A1A] text-white' : 'bg-[#FBFBF2]'}`}>
      <div className={`py-4 sm:py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col justify-between min-h-[calc(100vh-80px)]`}>
        ...
        <div className="relative my-4 flex-grow flex items-center justify-center">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="w-full relative flex flex-col md:grid md:grid-cols-2 gap-8 lg:gap-10 items-stretch"
            >
              ...
              <div className="flex md:absolute top-1/2 left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 z-30 pointer-events-none items-center justify-center my-[-20px] md:my-0">
